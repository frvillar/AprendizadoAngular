...
export class PessoasGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    this.cproj2Ds.getPessoas(null, this.grid0.allowPaging ? this.grid0.pageSize : null, this.grid0.allowPaging ? 0 : null, null, this.grid0.allowPaging, `Papei`)
  ...
  grid0LoadData(event: any) {
    this.cproj2Ds.getPessoas(`${event.filter}`, event.top, event.skip, `${event.orderby}`, event.top != null && event.skip != null, `Papei`)
    .subscribe((result: any) => {
      this.getPessoasResult = result.value;
  ...
  grid0Delete(event: any) {
    this.cproj2Ds.deletePessoa(event.Pessoa1)
    .subscribe((result: any) => {
