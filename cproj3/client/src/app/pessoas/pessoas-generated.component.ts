...
export class PessoasGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    this.cproj3Ds.getPessoas(null, this.grid0.allowPaging ? this.grid0.pageSize : null, this.grid0.allowPaging ? 0 : null, null, this.grid0.allowPaging, `Papei`, null, null)
  ...
  grid0LoadData(event: any) {
    this.cproj3Ds.getPessoas(`${event.filter}`, event.top, event.skip, `${event.orderby}`, event.top != null && event.skip != null, `Papei`, null, null)
    .subscribe((result: any) => {
      this.getPessoasResult = result.value;
  ...
  grid0Delete(event: any) {
    this.cproj3Ds.deletePessoa(event.Pessoa1)
    .subscribe((result: any) => {
