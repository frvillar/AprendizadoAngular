...
export class PapeisGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    this.cproj3Ds.getPapeis(null, this.grid0.allowPaging ? this.grid0.pageSize : null, this.grid0.allowPaging ? 0 : null, null, this.grid0.allowPaging, null, null, null)
  ...
  grid0LoadData(event: any) {
    this.cproj3Ds.getPapeis(`${event.filter}`, event.top, event.skip, `${event.orderby}`, event.top != null && event.skip != null, ``, null, null)
    .subscribe((result: any) => {
      this.getPapeisResult = result.value;
  ...
  grid0Delete(event: any) {
    this.cproj3Ds.deletePapei(event.Papel)
    .subscribe((result: any) => {
